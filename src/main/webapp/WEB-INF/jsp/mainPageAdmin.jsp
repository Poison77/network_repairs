    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand ">河工大网络服务平台</a>
            </div>
            <div class="collapse navbar-collapse navbar-right" id="example-navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a>工号:${userId}</a></li>
                    <li><a>角色:${userRole}</a></li>
                    <li><a style="cursor: pointer" onclick="window.location.href='${pageContext.request.contextPath}/log/logout.action'">退出</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="div1">
            ...
            <div class="div3">
                <ul>
                    ...
                    <li> <a href="${pageContext.request.contextPath}/worker/searchBillIndex.action" target="listIframe"> 账单查询</a></li>
            ...
            <div class="div3">
                <ul>
                    <li> <a href="${pageContext.request.contextPath}/admin/queryWorker.action" target="listIframe">员工管理</a></li>
                    <li> <a href="${pageContext.request.contextPath}/admin/queryUser.action" target="listIframe"> 用户管理</a></li>
                </ul>
            </div>
        </div>
    </div>
